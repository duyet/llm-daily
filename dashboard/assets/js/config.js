...
function loadConfig() {
    ...
    const config = {
        repoOwner: getConfigValue('repo_owner', autoDetected?.owner || 'duyet'),
        repoName: getConfigValue('repo_name', autoDetected?.name || 'llm-daily'),
        githubApiBase: getConfigValue('github_api_base', 'https://api.github.com'),
